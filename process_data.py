...
SPECIES = {
    ...
    "Apple":              dict(edible=True, cat="fruit", emoji="\U0001F34F", part="Fruit", season=[8,9,10], peak=[9], note="Look for unsprayed neighborhood trees dropping fruit.", ferment="The original Scrump: press windfall apples into scrumpy cider."),
